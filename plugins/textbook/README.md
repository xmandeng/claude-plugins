...
<table>
  <tr>
    <td width="50%"><img src="./assets/screenshots/title-page.jpg" alt="Example title page"></td>
    <td width="50%"><img src="./assets/screenshots/measurement-page.jpg" alt="Example body page"></td>
  </tr>
  <tr>
