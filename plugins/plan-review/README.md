...
2. Generates a review HTML at `.plan-review/TT-128-<slug>-review.html`
...
**Default:** `.plan-review/` (auto-created if missing). Keeps generated artifacts out of your project's source tree.
...
|---|---|---|
| `PLAN_REVIEW_DIR` | `.plan-review/` | Output directory for generated reviews |
